...
public class TriangleTest extends TestHelper {
    ...
    public void testIsSame() {
        Triangle triangle = new Triangle(new Vertex(1, 0), new Vertex(2, 3), new Vertex(4, 5));
        Triangle triangle2 = new Triangle(new Vertex(2, 3), new Vertex(4, 5), new Vertex(1, 0));
        Triangle triangle3 = new Triangle(new Vertex(2, 3), new Vertex(1, 0), new Vertex(8, 5));
    ...
    public void testContainsVertex() {
        Triangle triangle = new Triangle(new Vertex(1, 0), new Vertex(2, 3), new Vertex(4, 5));
        Vertex firstVertex = new Vertex(1, 0);
        Vertex secondVertex = new Vertex(2, 3);
        Vertex thirdVertex = new Vertex(4, 5);
        Vertex fourthVertex = new Vertex(1, 2);
